...
(cl:defmethod has_ref-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:has_ref-val is deprecated.  Use robot_msgs-srv:has_ref instead.")
  (has_ref m))

(cl:ensure-generic-function 'ref_joint-val :lambda-list '(m))
(cl:defmethod ref_joint-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:ref_joint-val is deprecated.  Use robot_msgs-srv:ref_joint instead.")
  (ref_joint m))
...
(cl:defmethod mvtime-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:mvtime-val is deprecated.  Use robot_msgs-srv:mvtime instead.")
  (mvtime m))

(cl:ensure-generic-function 'mvradii-val :lambda-list '(m))
(cl:defmethod mvradii-val ((m <Move-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:mvradii-val is deprecated.  Use robot_msgs-srv:mvradii instead.")
  (mvradii m))
