...
(cl:defmethod cl:initialize-instance :after ((m <SetLoad-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoad-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<SetLoad-request> is deprecated: use robot_msgs-srv:SetLoad-request instead.")))

(cl:ensure-generic-function 'tool_num-val :lambda-list '(m))
(cl:defmethod tool_num-val ((m <SetLoad-request>))
...
(cl:defmethod mass-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:mass-val is deprecated.  Use robot_msgs-srv:mass instead.")
  (mass m))

(cl:ensure-generic-function 'xc-val :lambda-list '(m))
(cl:defmethod xc-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:xc-val is deprecated.  Use robot_msgs-srv:xc instead.")
  (xc m))

(cl:ensure-generic-function 'yc-val :lambda-list '(m))
(cl:defmethod yc-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:yc-val is deprecated.  Use robot_msgs-srv:yc instead.")
  (yc m))

(cl:ensure-generic-function 'zc-val :lambda-list '(m))
(cl:defmethod zc-val ((m <SetLoad-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-srv:zc-val is deprecated.  Use robot_msgs-srv:zc instead.")
  (zc m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetLoad-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetLoad-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<SetLoad-response> is deprecated: use robot_msgs-srv:SetLoad-response instead.")))
