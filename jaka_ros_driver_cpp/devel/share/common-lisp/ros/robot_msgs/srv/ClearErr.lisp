...
(cl:defmethod cl:initialize-instance :after ((m <ClearErr-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClearErr-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<ClearErr-request> is deprecated: use robot_msgs-srv:ClearErr-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ClearErr-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ClearErr-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-srv:<ClearErr-response> is deprecated: use robot_msgs-srv:ClearErr-response instead.")))
